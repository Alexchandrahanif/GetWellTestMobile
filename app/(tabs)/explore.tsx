  ...
  return (
    <View className=''>
      ...
      <View className="w-full h-[100px] relative">
        <View className="w-full h-[45px] bg-[#1F978D] rounded-b-[16px] absolute top-0" />

        <View className="w-[92%] h-[100px] bg-white rounded-xl absolute flex flex-row p-[16px] gap-3 left-[28px] -translate-x-1/2">
      ...
      <View className='w-full h-[58px] flex flex-row px-[16px] mt-4 justify-between '>
        <TouchableOpacity onPress={() => router.push('/HasilKonsultasi')}>
        ...
        <TouchableOpacity onPress={() => router.push('/HasilLaboraturium')}>
          <View className='h-[58px] w-[170px] border-[1px] border-slate-300 rounded-lg p-[8px] gap-1 flex flex-row'>
